...
default:
	...
	g++ -Wall -Wextra -pedantic -m64 -O3 -flto -march=native -funroll-loops *.o  -o pcat-dnest -rdynamic -L/n/fink1/sportillo/software/lib -lrjobject -ldnest3 -lgsl -lgslcblas -lboost_thread-mt -lboost_system-mt
	rm -f *.o
